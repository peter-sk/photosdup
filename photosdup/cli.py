...
def main(argv):
    ...
    print(args)
    df.represent(dimension=(args.xdim,args.ydim),max=args.max,batch=args.batch,cores=args.cores)
    df.find(radius=args.radius,prefix=args.prefix,batch=args.batch,cores=args.cores)
